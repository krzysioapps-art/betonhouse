...
const projects = [
  {
    title: "Dream House",
    subtitle: "Rezydencja",
    description: "Harmonia idealnego połączenia kubatury i funkcji.",
    ...
    <div className={styles.heroBottom}>
          ...
          <div className={styles.stickyContent}>
            <div className={styles.stickyIntro}>
              ...
              <p className={styles.lead}>
                <PolishText>
                  ...
                  Projekt zaczęliśmy prawie dekadę temu.
                </PolishText>
              </p>
            </div>
            ...
            <div className={styles.storySteps}>
              <article className={styles.storyStep}>
                <h3>
                  <PolishText>Od pierwszej kreski do codziennego życia.</PolishText>
                </h3>
                <p>
                  <PolishText>
                    Realizacja stała się dla nas pierwszym doświadczeniem
                    tworzenia architektury od początku do końca — bez dystansu
                    między projektem a tym, jak naprawdę się w nim mieszka.
                  </PolishText>
                </p>
              </article>
              ...
              <article className={styles.storyStep}>
                ...
                <p>
                  <PolishText>
                    Ponad 500 m² betonu, szkła, światła i przestrzeni pozwoliło
                    nam sprawdzić własne pomysły w praktyce. Zobaczyliśmy, co
                    działa, co wymaga zmiany i jak przestrzeń zachowuje się,
                    kiedy zaczynamy w niej żyć.
                  </PolishText>
                </p>
              </article>
              ...
              <article className={styles.storyStep}>
                ...
                <p>
                  <PolishText>
                    ...
                    Dopiero codzienność pokazała nam, jak przestrzeń zachowuje
                    się rano, wieczorem, latem i zimą.
                  </PolishText>
                </p>
              </article>
              ...
              <article className={styles.storyStep}>
                <h3>
                  <PolishText>Architektura przestaje być abstrakcją.</PolishText>
                </h3>
                <p>
                  <PolishText>
                    To doświadczenie jest dla nas równie ważne jak sam projekt.
                    Przestrzeń zaczyna naprawdę uczestniczyć w życiu dopiero,
                    kiedy można ją codziennie sprawdzać.
                  </PolishText>
                </p>
              </article>
            </div>
      ...
      <section className={styles.experienceSticky}>
        <div className={styles.experienceGrid}>
          <div className={styles.experienceContent}>
            <h2 className={styles.heading}>
              <PolishText>Materiał nie jest dekoracją.</PolishText>
            </h2>

            <div className={styles.experienceCopy}>
              <p className={styles.lead}>
                <PolishText>
                  Beton, szkło i światło nie są dla nas warstwą nakładaną na
                  projekt. Są jego konstrukcją.
                </PolishText>
              </p>
              <p className={styles.body}>
                <PolishText>
                  Własny dom nauczył nas patrzeć na materiały nie tylko przez
                  pryzmat obrazu, ale także dotyku, temperatury, akustyki,
                  światła i codziennego użytkowania.
                </PolishText>
              </p>
              <p className={styles.body}>
                <PolishText>
                  To właśnie dlatego doświadczenie realizacji zabieramy ze sobą
      ...
      <section className={`${styles.lightSplit} ${styles.split}`}>
        ...
        <div className={styles.splitText}>
          <h2 className={styles.heading}>
            <PolishText>Chcieliśmy, żeby światło było częścią domu.</PolishText>
          </h2>
          <p className={styles.lead}>
            <PolishText>
